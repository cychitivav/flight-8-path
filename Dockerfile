...
WORKDIR /root/workspace/src/flight-8-path
...
# docker run -it --rm --name flight-8-path -v /tmp/.X11-unix:/tmp/.X11-unix -v $PWD:/root/workspace/src/flight-8-path -e DISPLAY=$DISPLAY flight-8-path:latest